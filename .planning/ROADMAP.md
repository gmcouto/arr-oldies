...
- [ ] **Phase 1: Foundation, Multi-Instance Configuration & CLI Scaffolding** - Establish project foundation, Pydantic schemas, YAML config loading, validation command, and base CLI
...
Plans:
- [ ] 01-01: Project structure, Pydantic models, and YAML config loader
- [ ] 01-02: Base Typer CLI app, `validate-config` command, and instance targeting logic
